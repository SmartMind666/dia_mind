...
def evaluate(model, tokenizer, dataset_path, generate_response_func, max_new_tokens=2048, model_name=""):
    ...
    dataset = test_dataset.train_test_split(test_size=200, seed=3834)
...
train_sft2_without_sft1_no_instruct(model_path="/root/autodl-tmp", model_name='qwen-7b-instrcut')